...
class ContactRequest extends FormRequest
{
    ...
    public function messages(){
        return[
            ...
            'tel_first.digits_between:1,5' => '電話番号は5桁までの数字で入力してください',
            'tel_second.digits_between:1,5' => '電話番号は5桁までの数字で入力してください',
            'tel_third.digits_between:1,5' => '電話番号は5桁までの数字で入力してください',
